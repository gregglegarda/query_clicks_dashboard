...
// append the svg object to the body of the page
	...
	/**************SAMPLE DATA**********/
	//var xAxisTickLabels = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"];
	//var yAxisTickLabels = ["v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10"];
	...
	//console.log(JSON.stringify(Math.max.apply(Math, data.map(function(o) { return o['value']; }))));
...
// Build color scale
	var myColor = d3.scaleLinear()
		.range(["white", "#69b3a2"])
		.domain([1, Math.max.apply(Math, data.map(function(o) { return o['value']; }))])
