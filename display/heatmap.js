...
function display_heatmap(data) {
	d3.selectAll("#heatmapElementVeriftype > *").remove();
...
// append the svg object to the body of the page
	var svg = d3.select("#heatmapElementVeriftype")
		.append("svg")
...
// Labels of row and columns
   ...
   // var keysY = pairKeyValueY[0];
	...
	/**************SAMPLE DATA**********/
	var myX = arrayOfElementNames; //["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"];
	var myY = arrayOfVeriftypeNames; //["v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10"];
